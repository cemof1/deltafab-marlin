...
void menu_tmc();
  ...
  //
  int dual_ex_filament =0;// Filament menüsünü düzenlemek ve 2. ekstrüder i gizlemek için
  void menu_advanced_filament() {
    START_MENU();
    MENU_BACK(MSG_ADVANCED_SETTINGS);
    #if ENABLED(DUAL_EX)
    dual_ex_filament=analogRead(A3);
    #endif
      ...
      if (parser.volumetric_enabled) {
          ...
          #if ENABLED(DUAL_EX)
          if(65<dual_ex_filament && dual_ex_filament<125){
          EDIT_FIL_DIAM(1);
          EDIT_FIL_DIAM(2);
          }
          #endif
      ...
      ;
        ...
        #if ENABLED(DUAL_EX)// unload menüsünü gizlemek için eklendi
        if(65<dual_ex_filament && dual_ex_filament<125)//unload menüsünü gizlemek için eklendi
        {EDIT_FIL_UNLOAD(1);// bu satır orjinalinde de vardı
        EDIT_FIL_UNLOAD(2);// bu satır orjinalinde de vardı
        }
        #endif// unload menüsünü gizlemek için eklendi
        #if EXTRUDERS > 2
          EDIT_FIL_UNLOAD(3);
          #if EXTRUDERS > 3
            EDIT_FIL_UNLOAD(4);
        ...
        #if ENABLED(DUAL_EX)// load menüsünü gizlemek için eklendi
        if(65<dual_ex_filament && dual_ex_filament<125){// load menüsünü gizlemek için eklendi
        EDIT_FIL_LOAD(1);// bu satır orjinalinde de vardı
        EDIT_FIL_LOAD(2);}// bu satır orjinalinde vardı
        #endif
        #if EXTRUDERS > 2
          EDIT_FIL_LOAD(3);
          #if EXTRUDERS > 3
