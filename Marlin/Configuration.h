 ...
 */
#pragma once
//#define DELTAFAB_KAFA_ALGILAMA
#define DELTAFAB_KAFA_CESIDI_ALGILAMA
#define CERAMIC_CUP
#define DUAL_EX
/**
 * Configuration.h
...
#define STRING_CONFIG_H_AUTHOR "(Deltafab Teknoloji)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "DELTAFAB ONE V1.0" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "www.deltafab3d.com" // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "DELTAFAB ONE"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //DELTAFAB 24V halka rezistans thermistor 5 kullanıldı
  ...
  //E3D with 30MM fan
  //#define DEFAULT_Kp 8.02
  //#define DEFAULT_Ki 0.28
  //#define DEFAULT_Kd 56.82
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 9.79
  #define DEFAULT_bedKd 142.11
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 40.0 // (mm)
  ...
  #define DELTA_DIAGONAL_ROD 228.00      // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 337.53             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0, -1.13, -6.84 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 138.06              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 1.292, -0.011, -1.281 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 160.0 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    15 // Z Clearance for Deploy/Stow//5
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points//2
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION -45 //-(DELTA_PRINTABLE_RADIUS - (MIN_PROBE_EDGE))
  #define RIGHT_PROBE_BED_POSITION 45 //(DELTA_PRINTABLE_RADIUS - (MIN_PROBE_EDGE))
  #define FRONT_PROBE_BED_POSITION -45 //-(DELTA_PRINTABLE_RADIUS - (MIN_PROBE_EDGE))
  #define BACK_PROBE_BED_POSITION 45 //(DELTA_PRINTABLE_RADIUS - (MIN_PROBE_EDGE))
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 300 }   //{ (X_MIN_POS + 10), 0, 300 }
...
#define CERAMIC_CUP
#define DUAL_EX
/* temperature.cpp kütüphanesinde manage_heater() fonksiyonu içerisinde şartlanarak fan aç kapa yaptırılıyor.*/
//#define DELTAFAB_SMART_FAN
/* Probe.cpp kütüphanesinde probe_triggered değişkenini şartlayarak 3 mıknatısın herhangi birinin ayrılması ile 
proplama yapılıyor.*/
//#define DELTAFAB_PROBE
//#define LASER_PAUSE
/* EKOYA BASKI ANINDA YÜZDEYİ YAZMA KODU cardreader.cpp sayfasında report_status fonksiyonunun içindedir.*/