...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Used Script Done"
...
/**
 * DELTAFAB wifi confirgation
 * 
 * 
 */
#define Deltafab_wifi
  #if ENABLED(Deltafab_wifi)
  #define deltafab_wifi_PIN 11
  #define deltafab_wifi_DEFAULT_ON true
  #endif
